...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class OfferController : Controller
    {
        ...
        private readonly BulkyBook.DataAccess.Data.ApplicationDBContext _dbContext;

        public OfferController(IUnitOfWork unitOfWork, IStringLocalizer<BulkyBook.SharedResources> localizer, BulkyBook.DataAccess.Data.ApplicationDBContext dbContext)
        {
